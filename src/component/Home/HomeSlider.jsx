            ...
            <Carousel>
                <Carousel.Item>
                    ...
                    <Fade>
                        <Col lg={12} sm={12}>
                        <Carousel.Caption>
                            <h1 className='fw-bold'>Get <span>ready</span> for your business <br /> & upgrade  <span>all aspects</span></h1>
                ...
                <Carousel.Item>
                    ...
                    <Col lg={12} sm={12}>
                        <Carousel.Caption>
                            <h1 className='fw-bold'><span>Digital</span> Currency for you<br />& Best <span>Crypto</span> Tips</h1>
                            <div className='line mt-3'></div>
                ...
                <Carousel.Item>
                    ...
                    <Col lg={12} sm={12}>
                        <Carousel.Caption>
                            <h1 className='fw-bold'>Best One in Town<br />& Crypto <span>Services</span></h1>
                            <div className='line mt-3'></div>
